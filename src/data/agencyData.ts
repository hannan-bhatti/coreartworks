...
export const AGENCY_SERVICES: ServiceOffering[] = [
  ...
  },
  {
    ...
    description: 'Custom D&D character portraits, detailed anthro/fursona reference sheets, party splashes, fantasy weapons, and lore-rich OC illustrations.',
    deliverables: ['High-DPI Character Portraits', 'Full-Body Reference Sheets', 'Character Battle Tokens', 'Epic Battle Scene Splashes'],
